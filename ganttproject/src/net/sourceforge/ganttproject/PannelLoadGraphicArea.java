 ...
 *
 * TODO:
 *      1. Remove what is not usuful
 *      2. Check why name on the tab has not changed
 */
public class PannelLoadGraphicArea extends ChartComponentBase implements ResourceChart {
    ...
    public PannelLoadGraphicArea(GanttProject app, ZoomManager zoomManager, ResourceTreeUIFacade treeUi) {
    ...
    public String getName() {
        return GanttLanguage.getInstance().getText("planner");
    }
