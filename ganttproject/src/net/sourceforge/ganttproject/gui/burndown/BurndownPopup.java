 ...
 */
package net.sourceforge.ganttproject.gui.burndown;
...
pixa maxima
 */
public class BurndownPopup extends AbstractPagesDialog {
  ...
  private static ListItem createSummaryPage() {
    ...
    JLabel icon = new JLabel(new ImageIcon(BurndownPopup.class.getResource("/icons/ganttproject.png")));
